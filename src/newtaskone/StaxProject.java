package task74_76.box75;
/*
Задание 75. Напишите программу, которая будет разбирать xml файл, сделанный в предыдущем задании, с помощью StAX,
            и выводит его на экран в текстовом виде.Каждая точка должна выводитьcя на отдельной строке в виде двух
